      ...
      >
        ...
        <View className="px-5 pt-12 pb-4">
          <View className="flex-row justify-between items-start">
            <View>
              <Text className="text-2xl font-bold text-slate-800">Tank Monitor</Text>
              <Text className="text-sm text-slate-400">Ultrasonic sensor · Live</Text>
            </View>
        ...
        <View className="mx-5 bg-white rounded-2xl p-6 mb-5 shadow-sm border border-slate-200">
          <Text className="text-xs font-semibold text-slate-400 tracking-wider text-center mb-4">CURRENT WATER LEVEL</Text>
          ...
          <View className="items-center mb-6">
            <View className="relative">
              ...
              {/* Tank Container */}
              <View className="w-32 h-48 rounded-3xl border-4 border-slate-300 overflow-hidden justify-end bg-slate-50">
                <View 
              ...
              <View className="absolute -right-4 top-0 bottom-0 justify-between py-2">
                <View className="w-2 h-0.5 bg-slate-300" />
                <View className="w-2 h-0.5 bg-slate-300" />
                <View className="w-2 h-0.5 bg-slate-300" />
                <View className="w-2 h-0.5 bg-slate-300" />
                <View className="w-2 h-0.5 bg-slate-300" />
          ...
          {/* Status Text */}
          <Text className="text-2xl font-bold text-slate-800 text-center mb-1">{tankData.status}</Text>
          <Text className="text-sm text-slate-500 text-center">{getWaterRemaining()} litres remaining</Text>
        </View>
        ...
        <View className="flex-row flex-wrap px-5 mb-5 justify-between">
          ...
          <View className="w-[48%] bg-white rounded-2xl p-4 mb-4 shadow-sm">
            ...
            <Text className="text-2xl font-bold text-slate-800 mb-0.5">{tankData.totalCapacity}L</Text>
            <Text className="text-xs text-slate-500">Total capacity</Text>
          </View>
          ...
          <View className="w-[48%] bg-white rounded-2xl p-4 mb-4 shadow-sm">
            ...
            <Text className="text-2xl font-bold text-slate-800 mb-0.5">{getWaterRemaining()}L</Text>
            <Text className="text-xs text-slate-500">Water remaining</Text>
          </View>
          ...
          <View className="w-[48%] bg-white rounded-2xl p-4 mb-4 shadow-sm">
            ...
            <Text className="text-2xl font-bold text-slate-800 mb-0.5">{tankData.sensorDistance}cm</Text>
            <Text className="text-xs text-slate-500">Sensor distance</Text>
          </View>
        </View>

        {/* Alert Thresholds */}
        <View className="px-5 mb-8">
          <Text className="text-xs font-semibold text-slate-400 tracking-wider mb-4">ALERT THRESHOLDS</Text>
          ...
          <View className="bg-white rounded-2xl p-4 shadow-sm">
            ...
            <View className="flex-row items-center justify-between mb-4 pb-4 border-b border-slate-100">
              <View className="flex-row items-center flex-1">
                ...
                <Text className="text-sm font-semibold text-slate-700">Almost empty</Text>
              </View>
            ...
            <View className="flex-row items-center justify-between mb-4 pb-4 border-b border-slate-100">
              <View className="flex-row items-center flex-1">
                ...
                <Text className="text-sm font-semibold text-slate-700">Running low</Text>
              </View>
            ...
            <View className="flex-row items-center justify-between mb-4 pb-4 border-b border-slate-100">
              <View className="flex-row items-center flex-1">
                ...
                <Text className="text-sm font-semibold text-slate-700">Nearly full</Text>
              </View>
            ...
            <View className="flex-row items-center justify-between">
              <View className="flex-row items-center flex-1">
                ...
                <Text className="text-sm font-semibold text-slate-700">Overflowing</Text>
              </View>
              <View className="bg-red-100 px-3 py-1 rounded-full">
