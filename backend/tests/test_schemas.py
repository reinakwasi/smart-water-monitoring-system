...
class TestSensorDataRequest:
    ...
    def test_valid_sensor_data(self):
        ...
        assert request.turbidity_index == 15.5
    ...
    def test_turbidity_out_of_range(self):
        ...
        assert "turbidity_index" in str(exc_info.value)
    ...
    def test_tds_out_of_range(self):
        """Test TDS above 2000 is rejected"""
        data = {
            "device_id": "ESP32_001",
            "timestamp": "2025-01-15T10:30:00Z",
            "ph": 7.2,
    ...
    def test_legacy_dissolved_oxygen_is_not_a_sensor_field(self):
        """Legacy clients may send DO, but it is not exposed as a sensor value."""
        data = {
            "device_id": "ESP32_001",
            "timestamp": "2025-01-15T10:30:00Z",
            "ph": 7.2,
        ...
        assert not hasattr(request, "dissolved_oxygen")
...
class TestSerializationRoundTrip:
    ...
    def test_sensor_data_round_trip(self):
        ...
        assert request1.turbidity_index == request2.turbidity_index
