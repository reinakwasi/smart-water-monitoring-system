...
async def health_check(
    ...
    # Step 1: Check MongoDB connection status and latency
    ...
    # Step 2: Check ML models loaded status and versions
    ...
    # Step 4: Report sensor device online/offline status
    ...
    # Step 5: Determine overall system health
