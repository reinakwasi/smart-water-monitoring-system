...
class EmailService:
    # RFC-reserved domains must never be sent through real SMTP. They are used
    # throughout the automated test suite and do not have working mailboxes.
    RESERVED_DOMAINS = {
        "example.com",
        "example.net",
        "example.org",
    ...
    def __init__(self):
        ...
        logger.info(
            ...
            extra={"extra_fields": {"smtp_configured": bool(self.smtp_user and self.smtp_password)}}
        )
    ...
    def send_email(self, to_email: str, subject: str, html_content: str) -> bool:
        """Send email via SMTP"""
        try:
            # Pytest must never contact an external SMTP server. Returning True
            # simulates successful delivery so endpoint tests can continue while
            # keeping OTP generation and storage behaviour under test.
            if os.getenv("PYTEST_CURRENT_TEST"):
                logger.info("Email delivery suppressed during automated test")
                return True

            domain = to_email.rsplit("@", 1)[-1].strip().lower()
            if (
                domain in self.RESERVED_DOMAINS
                ...
                logger.warning(
                    "Email delivery suppressed for reserved placeholder domain: "
                    f"{domain}"
                )
                return True
            ...
            try:
                ...
                with smtplib.SMTP(self.smtp_host, self.smtp_port, timeout=15) as server:
                    # SMTP debug output can expose recipients and OTP content.
        ...
        <body>
            <div class="container">
                ...
                <div class="content">
                    ...
                    <div class="feature">
                        <strong>Model-Based Water Insights</strong><br>
